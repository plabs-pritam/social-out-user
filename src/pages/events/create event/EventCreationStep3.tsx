...
const EventCreationStep3 = ({ handleAccountSelection }: { handleAccountSelection: any }) => {
  return (
    <>
      <div className="text-[28px] font-bold">Venue</div>
...
export default EventCreationStep3;
